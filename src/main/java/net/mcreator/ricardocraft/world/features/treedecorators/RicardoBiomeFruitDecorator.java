...
public class RicardoBiomeFruitDecorator extends CocoaDecorator {
	public static final RicardoBiomeFruitDecorator INSTANCE = new RicardoBiomeFruitDecorator();
	public static com.mojang.serialization.Codec<RicardoBiomeFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ricardo_biome_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public RicardoBiomeFruitDecorator() {
		super(0.2f);
	}
