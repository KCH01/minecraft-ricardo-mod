...
public class RicardoBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final RicardoBiomeLeaveDecorator INSTANCE = new RicardoBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ricardo_biome_tree_leave_decorator");
